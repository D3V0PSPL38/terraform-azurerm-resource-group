...
| <a name="input_resource_group_per_resource"></a> [resource\_group\_per\_resource](#input\_resource\_group\_per\_resource) | [Optional] If set to `true` a resource group for each resource that will be created with this module. | `bool` | `false` | no |
